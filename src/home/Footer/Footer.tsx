      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
        <div className="flex flex-col md:flex-row justify-between gap-10 md:gap-0 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            {/* Contact Info */}
            <div className="flex flex-col gap-4 text-gray-700 text-base mt-2">
              {/* Phone (click to call) */}
              <Link
                href="tel:+8801316433225"
                className="flex items-center justify-center md:justify-start gap-2 hover:text-indigo-600 transition"
              >
                <Phone size={18} className="text-indigo-600" />
                <span>+8801316433225</span>
              </Link>

              {/* Email (click to open mail app) */}
              <Link
                href="mailto:info.quicklaunch25@gmail.com"
                className="flex items-center justify-center md:justify-start gap-2 hover:text-indigo-600 transition"
              >
                <Mail size={18} className="text-indigo-600" />
                <span>info.quicklaunch25@gmail.com</span>
              </Link>

              {/* Address (static for now) */}
              <div className="flex items-center justify-center md:justify-start gap-2">
                <MapPin size={18} className="text-indigo-600" />
                <span>Shonir Akhra R/A, Kodomtoli, Dhaka, 1312</span>
              </div>
            </div>
